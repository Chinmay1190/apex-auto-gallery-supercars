  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-gold": { "0%, 100%": { boxShadow: "0 0 20px hsl(43 74% 49% / 0.2)" }, "50%": { boxShadow: "0 0 40px hsl(43 74% 49% / 0.4)" } },
        "spin-wheel": { from: { transform: "rotate(0deg)" }, to: { transform: "rotate(360deg)" } },
      },
      animation: {
        ...
        "spin-wheel": "spin-wheel 2s linear infinite",
      },
    },
  },
